...
const WhyChooseUs = () => {
  return (
    <section className="py-16 px-6 bg-brand-black relative overflow-hidden">
      {/* Decorative Elements */}
      <div className="absolute top-0 right-0 w-96 h-96 bg-brand-yellow/5 rounded-full blur-[100px] -mr-48 -mt-48" />
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-12">
          ...
          >
            Why Choose <span className="text-gradient-yellow">Showthink?</span>
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {reasons.map((reason, index) => (
            <motion.div
              ...
              whileHover={{ y: -10 }}
              className="glass-card p-8 group hover:border-brand-yellow/50 transition-all duration-300"
            >
