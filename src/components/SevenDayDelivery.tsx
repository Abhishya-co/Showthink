    ...
    <section className="py-24 px-6 bg-brand-black relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-20">
          ...
          >
            ⚡ Get Your Website Delivered in <span className="text-gradient-gold">Just 7 Days</span>
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 relative">
            {timelineSteps.map((step, index) => (
              <motion.div
                ...
                className="glass-card p-8 relative group hover:border-brand-gold/30 transition-all"
              >
                <div className="w-12 h-12 bg-brand-gold text-brand-black rounded-full flex items-center justify-center font-bold text-lg mb-6 shadow-[0_0_15px_rgba(255,215,0,0.3)] group-hover:scale-110 transition-transform">
                  {index + 1}
                </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {trustBadges.map((badge, index) => (
            ...
            >
              <badge.icon className="text-brand-gold shrink-0" size={20} />
        ...
        <div className="text-center">
          ...
          >
            ...
            <p className="text-brand-gold font-bold flex items-center justify-center gap-2 animate-pulse">
